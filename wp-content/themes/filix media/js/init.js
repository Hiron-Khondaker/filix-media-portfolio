...
function dizme_tm_submenu() {

    var WW = jQuery(window).width();
    var submenu = jQuery('.dizme_tm_header .sub-menu');
...
function dizme_tm_versubmenu() {

    jQuery(".dizme_tm_mobile_menu .dropdown .dropdown_inner a").on('click', function() {
        var e = jQuery(this);
        var p = e.closest('li');
...
function dizme_tm_service_popup() {
    ...
    button.on('click', function() {
        ...
        modalBox.find('.service_popup_informations').prepend('<div class="image"><img src="https://shtheme.com/demosd/dizme/wp-content/themes/dizme/img/thumbs/4-2.jpg" alt="" /><div class="main" data-img-url="' + elImage + '"></div></div>');
        dizme_tm_data_images();
...
function dizme_tm_modalbox_news() {
    ...
    var modalBox = jQuery('.dizme_tm_modalbox');
    var button = jQuery('.dizme_tm_news .dizme_tm_full_link1,.dizme_tm_news1 ul li .details1 .title a');
    var closePopup = modalBox.find('.close');
    ...
    button.on('click', function() {
        ...
        modalBox.addClass('opened');
        modalBox.find('.description_wrap').html(content);
        modalBox.find('.news_popup_informations').prepend('<div class="image"><img src="https://shtheme.com/demosd/dizme/wp-content/themes/dizme/img/thumbs/4-2.jpg" alt="" /><div class="main" data-img-url="' + image + '"></div></div>');
...
function dizme_tm_modalbox_portfolio() {
    ...
    button.off().on('click', function() {
        ...
        modalBox.addClass('opened');
        modalBox.find('.description_wrap').html(content);
        modalBox.find('.popup_details').prepend('<div class="top_image"><img src="https://shtheme.com/demosd/dizme/wp-content/themes/dizme/img/thumbs/4-2.jpg" alt="" /><div class="main" data-img-url="' + image + '"></div></div>');
